...
**OPTIONAL, if you have time** (from `launch/ANTIGRAVITY_PROMPT.md` wave-2, still open): the social/OG image kit and the architecture SVG. Same rules: no invented claims, the number that appears anywhere is **298 verified checks**.
